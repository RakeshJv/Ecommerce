...
public class GetAsynckTask  extends AsyncTask<Object, Object, Object> {
    ...
    public GetAsynckTask(String data, CompliantListPresenter compliantListPresenter , String api)
    {
