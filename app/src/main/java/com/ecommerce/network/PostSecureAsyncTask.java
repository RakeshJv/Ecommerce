...
public class PostSecureAsyncTask extends        AsyncTask<Object, Object, Object> {
    ...
    public PostSecureAsyncTask(String email, String password, CompliantListPresenter compliantListPresenter) {
        this.compliantListPresenter = compliantListPresenter;

    }

    public PostSecureAsyncTask(String data, CompliantListPresenter compliantListPresenter, String api) {
        this.compliantListPresenter = compliantListPresenter;
        this.api = api;
        this.data = data;
    }
    ...
    public PostSecureAsyncTask(String data, CompliantListPresenter compliantListPresenter) {
        this.compliantListPresenter = compliantListPresenter;
