...
/**
 * Created by rvaishya on 10/26/2017.
 */

public class PostRequestServerOperation
 {
    Activity activity;
    ...
    public PostRequestServerOperation(Activity activity, ServerResponseCallback serverResponce, String api, String requestMethod, boolean isSwipeRefresh) {
    ...
    public PostRequestServerOperation(Activity activity, ServerResponseCallback serverResponce, String api, String requestMethod, JSONObject jason ) {
        this.activity = activity;
        this.serverResponce = serverResponce;
        this.api = api;
        this.requestMethod = requestMethod;
